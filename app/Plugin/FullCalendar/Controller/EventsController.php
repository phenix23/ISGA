...
class EventsController extends FullCalendarAppController {
   ...
   public function list_formations() {
        ...
        $options = array('fields'=>array('Formation.id','Formation.name'),'recursive' => 0);
        $d['formations'] = $this->Formation->find('list',$options);
//        $this->render(APP_DIR.DS.'\Plugin\FullCalendar\View\Events\add'); 
        return $d['formations'];
    }
